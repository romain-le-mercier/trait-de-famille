...
| 2026-09-13 | T-000 | MEP constatée par Romain | dadc448 | filigrane : 0,00 % avant → présent après (constat visuel, non chiffré) | Filigrane à bandes déployé et vérifié **par Romain sur le site**, pas par moi : Cloudflare renvoyait un challenge sur toutes mes requêtes (`cf-mitigated: challenge`) depuis ce poste, API comprise, et l'extension navigateur n'était pas connectée. La couverture n'a donc **pas** été mesurée en production ; les 30,19 % annoncés restent une mesure locale. À rechiffrer en ligne à la première occasion, ou à laisser tel quel si le constat visuel suffit au PM. |
| 2026-09-22 | T-002 | pris | | | |
